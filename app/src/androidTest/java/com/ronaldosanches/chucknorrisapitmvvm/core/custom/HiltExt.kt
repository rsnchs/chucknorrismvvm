...
import com.ronaldosanches.chucknorrisapimvvm.presentation.jokes.activities.HiltTestActivity
...
inline fun <reified T : Fragment> launchFragmentInHiltContainer(
    ...
    ).putExtra( //hardcoded because EmptyFragmentActivity is internal
    ...
    ActivityScenario.launch<HiltTestActivity>(startActivityIntent).onActivity { activity ->
        val fragment : Fragment = activity.supportFragmentManager
            .fragmentFactory.instantiate(Preconditions.checkNotNull(T::class.java.classLoader),
                T::class.java.name)
